...
const rpID = 'mayconnect-backend-1.onrender.com'; // Your domain without https
const origin = `https://${rpID}`;

// 1. Start biometric registration - user enables fingerprint
...
// 2. Finish biometric registration
...
// 4. Finish biometric login - returns JWT
...
// 5. Verify biometric for purchase - returns true if fingerprint passes
