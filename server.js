...
// ================= DATA PLANS =================
const DATA_PLANS = [
  { plan_id:165, network:"MTN", type:"MAITAMA", price:1400, size:"5 GB", duration:"1 month", profit:150 },
  { plan_id:415, network:"AIRTEL", type:"GIFTING", price:999, size:"3.2 GB", duration:"1 month", profit:100 },
  ...
  { plan_id:329, network:"AIRTEL", type:"SME", price:1300, size:"6.5 GB", duration:"1 month", profit:150 },
  ...
  { plan_id:335, network:"GLO", type:"SME", price:2370, size:"9.8 GB", duration:"1 month", profit:200 },
  ...
  { plan_id:195, network:"GLO", type:"GIFTING", price:969, size:"3.9 GB", duration:"1 month", profit:100 },
  { plan_id:194, network:"GLO", type:"GIFTING", price:473, size:"1.05 GB", duration:"1 month", profit:50 },
  { plan_id:52, network:"AIRTEL", type:"Cheap data hub", price:1570, size:"5 GB", duration:"7 Days", profit:150 }
];

// ================= PAYSTACK =================
async function sendProfit(amount) {
  if (!amount || amount <= 0) return; // skip if zero or null
  try {
    await axios.post(
...
app.post("/api/airtime", auth, async (req, res) => {
  ...
  if (amount < 50) return res.status(400).json({ error: "Minimum amount is ₦50" });
