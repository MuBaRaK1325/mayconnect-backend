...
// ================= DATA PLANS =================
const DATA_PLANS = [
 { plan_id:165, network:"MTN", price:1400, size:"5GB", profit:100 },
 { plan_id:415, network:"AIRTEL", price:999, size:"3.2GB", profit:60 },
 { plan_id:414, network:"MTN", price:540, size:"2.5GB", profit:50 },
 { plan_id:413, network:"MTN", price:240, size:"1GB", profit:50 },
 { plan_id:394, network:"AIRTEL", price:600, size:"2GB", profit:60 },
 { plan_id:329, network:"AIRTEL", price:1300, size:"6.5GB", profit:100 },
 { plan_id:327, network:"AIRTEL", price:650, size:"3.2GB", profit:50 },
 { plan_id:359, network:"MTN", price:408, size:"2GB", profit:50 },
 { plan_id:335, network:"GLO", price:2370, size:"9.8GB", profit:100 },
 { plan_id:334, network:"GLO", price:600, size:"2.5GB", profit:50 },
 { plan_id:261, network:"GLO", price:445, size:"1GB", profit:50 },
 { plan_id:195, network:"GLO", price:969, size:"3.9GB", profit:60 },
 { plan_id:194, network:"GLO", price:473, size:"1GB", profit:50 },
 { plan_id:52, network:"AIRTEL", price:1570, size:"5GB", profit:100 }
];
...
async function sendProfit(amount) {
 await axios.post(
  "https://api.paystack.co/transfer",
  {
   source:"balance",
   amount:amount*100,
   recipient:process.env.PAYSTACK_RECIPIENT
  },
  {
   headers:{
...
app.get("/api/wallet",auth,async(req,res)=>{
 ...
 res.json({balance:r.rows[0].wallet_balance});
});
...
app.post("/api/change-pin",auth,async(req,res)=>{
 ...
 if(!await bcrypt.compare(currentPin,u.rows[0].pin))
...
app.post("/api/change-password",auth,async(req,res)=>{
 ...
 if(!await bcrypt.compare(currentPassword,u.rows[0].password))
...
app.post("/api/purchase",auth,async(req,res)=>{
 ...
 if(!p) return res.status(400).json({error:"Missing plan"});
